        ...
        $behaviors['access'] = [
            ...
            'rules' => [
                [
                    ...
                    'actions' => ['delete'],
                    'verbs' => ['delete'],
                    'roles' => [Constant::PERMISSION_MAIN_CONTENT.CoreConstant::PERMISSION_ACTION_DELETE],
                ...
                [
                    ...
                    'actions' => ['activate'],
                    'verbs' => ['get'],
                    'roles' => [Constant::PERMISSION_MAIN_CONTENT.CoreConstant::PERMISSION_ACTION_ACTIVATION],
                    'denyCallback' => function ($rule, $action) {
                        throw new ForbiddenHttpException();
                    }
                ],
